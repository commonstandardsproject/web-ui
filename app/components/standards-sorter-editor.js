...
const saveFile = (blob, suggestedName) => {
...
export default Ember.Component.extend({
  ...
  layout: hbs`
    ...
    <label for="csv-download" class="btn btn-lg btn-primary">      
      <input id="csv-download" class="btn btn-primary btn-md" type="button" onclick={{action "downloadCSV" target=this}} style="display: none;">
      Download CSV
    </label>
